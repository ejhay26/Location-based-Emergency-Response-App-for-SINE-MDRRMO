  ...
  private buildItems(): void {
    ...
    this.allItems = [
      ...
      },
      {
        ...
        category: 'Panels',
        title: 'Citizen ID Verifications',
      ...
      },
      {
        id: 'panel-analytics',
        category: 'Panels',
        title: 'Analytics & Response Times',
      ...
      },
      {
        id: 'panel-archive',
        category: 'Panels',
        title: 'Historical Incident Logs',
        subtitle: 'Archived emergency reports, resolved incident audits',
        icon: 'history',
      ...
      },
      {
        id: 'panel-feedback',
        category: 'Panels',
        title: 'Citizen Reviews & Feedback',
        subtitle: 'Emergency response ratings & community feedback',
        icon: 'star',
      ...
      },
      {
        id: 'panel-help',
        category: 'Panels',
        title: 'Help & Operations Procedures',
