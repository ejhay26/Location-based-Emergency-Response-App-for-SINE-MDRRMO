...
export class HelpPanel {
  ...
  readonly procedures: ProcedureGuide[] = [
    ...
    },
    {
      ...
      icon: 'broadcast',
      badgeColor: '#ffc409',
      description: 'How to write disaster advisories, attach media files, schedule future announcements, save drafts for review, and manage active, queued, and archived broadcasts.',
      steps: [
        {
        ...
        {
          id: 'draft-broadcasts-section',
          panel: 'broadcast',
          callout: 'Step 7: Saved Drafts Queue (Review & Edit)',
          subtext: 'All saved drafts appear in this section. Dispatchers can click "Review / Edit" to reload a draft back into the composer, edit details, and publish, or click "Discard" to remove it.',
          waitForInteraction: false,
        },
        {
          id: 'active-broadcasts-section',
          panel: 'broadcast',
          callout: 'Step 8: Active Announcements List',
        ...
        },
        {
          ...
          panel: 'broadcast',
          callout: 'Step 9: Scheduled Announcements Queue',
        ...
        },
        {
          ...
          panel: 'broadcast',
          callout: 'Step 10: Past & Archived History',
